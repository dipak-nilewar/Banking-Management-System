...
import { withdrawMoney } from "../withdrawalApi";
...
function Withdrawal() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (withdrawalAmount > 10000000) {
      const message =
        "Withdrawal amount cannot exceed ₹1,00,00,000.";
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div>
          ...
          <p className="mt-2 text-gray-500">
            Withdraw money from your active bank account.
          </p>
        </div>
        ...
        >
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-gray-400">
              Withdrawal cannot exceed your available balance.
            </p>
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-red-600 py-3 font-semibold text-white transition hover:bg-red-700 disabled:cursor-not-allowed disabled:bg-gray-300"
          >
        ...
        <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm leading-6 text-gray-600">
              Withdrawals are processed securely. You can only
              withdraw from your own active accounts, and the
              withdrawal amount cannot exceed your available
              balance.
            </p>
